...
import type { DiagnosisResult as _DiagnosisResult, ExternalBlob as _ExternalBlob, HealthStatus as _HealthStatus, Time as _Time, UserProfile as _UserProfile, UserRole as _UserRole, UserWithDiagnoses as _UserWithDiagnoses, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addDiagnosis(arg0: string, arg1: HealthStatus, arg2: Array<string>, arg3: Array<string>, arg4: Array<string>, arg5: Array<string>, arg6: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addDiagnosis(arg0, to_candid_HealthStatus_n8(this._uploadFile, this._downloadFile, arg1), arg2, arg3, arg4, arg5, await to_candid_opt_n10(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async analyzePlantImage(arg0: ExternalBlob): Promise<DiagnosisResult> {
        if (this.processError) {
            try {
                const result = await this.actor.analyzePlantImage(await to_candid_ExternalBlob_n11(this._uploadFile, this._downloadFile, arg0));
                return from_candid_DiagnosisResult_n12(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async clearDiagnosisHistory(arg0: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.clearDiagnosisHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllUsersDiagnoses(): Promise<Array<UserWithDiagnoses>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllUsersDiagnoses();
    ...
    async getDiagnosisHistory(arg0: Principal): Promise<Array<DiagnosisResult>> {
        if (this.processError) {
            try {
                const result = await this.actor.getDiagnosisHistory(arg0);
...
async function from_candid_DiagnosisResult_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DiagnosisResult): Promise<DiagnosisResult> {
...
async function from_candid_UserWithDiagnoses_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _UserWithDiagnoses): Promise<UserWithDiagnoses> {
...
async function from_candid_record_n13(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        pesticideRecommendations: value.pesticideRecommendations,
        fertilizerRecommendations: value.fertilizerRecommendations,
...
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    user: Principal;
    diagnoses: Array<_DiagnosisResult>;
    ...
    return {
        user: value.user,
        diagnoses: await from_candid_vec_n23(_uploadFile, _downloadFile, value.diagnoses),
        profile: record_opt_to_undefined(from_candid_opt_n24(_uploadFile, _downloadFile, value.profile))
    };
}
...
function from_candid_variant_n15(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return "mild" in value ? HealthStatus.mild : "healthy" in value ? HealthStatus.healthy : "severe" in value ? HealthStatus.severe : "moderate" in value ? HealthStatus.moderate : value;
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_UserWithDiagnoses>): Promise<Array<UserWithDiagnoses>> {
    return await Promise.all(value.map(async (x)=>await from_candid_UserWithDiagnoses_n21(_uploadFile, _downloadFile, x)));
}
async function from_candid_vec_n23(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DiagnosisResult>): Promise<Array<DiagnosisResult>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DiagnosisResult_n12(_uploadFile, _downloadFile, x)));
}
...
function to_candid_HealthStatus_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: HealthStatus): _HealthStatus {
...
function to_candid_variant_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: HealthStatus): {
    mild: null;
} | {
    healthy: null;
} | {
    ...
    return value == HealthStatus.mild ? {
        mild: null
    } : value == HealthStatus.healthy ? {
        healthy: null
    } : value == HealthStatus.severe ? {
        severe: null
    } : value == HealthStatus.moderate ? {
        moderate: null
    } : value;
}
